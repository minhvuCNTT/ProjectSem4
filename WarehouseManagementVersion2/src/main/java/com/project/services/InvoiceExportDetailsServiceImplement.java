...
@Service
@Transactional
public class InvoiceExportDetailsServiceImplement implements InvoiceExportDetailsService{
	...
	public InvoiceExportDetails save(InvoiceExportDetails invoiceExportDetails) {
		...
		return invoiceExportDetailsRepository.save(invoiceExportDetails);
	}
