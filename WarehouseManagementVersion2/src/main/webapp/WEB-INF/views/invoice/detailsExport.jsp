...
<mt:template title="Deatils Export invoice">
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Details export invoice</h1>
          </div>
					<!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="${pageContext.request.contextPath }/invoice/invoiceExportPrint?id=${invoiceExport.id }" 
                  						rel="noopener"
