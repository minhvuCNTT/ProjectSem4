...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/resources/dat/font-awesome.css">

<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/dat/templatemo-hexashop.css">

<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/dat/owl-carousel.css">

<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/dat/lightbox.css">
	
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/dat/image.css">
<!-- ---------------- -->
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a class="brand-link"> <img
				src="${pageContext.request.contextPath }/resources/dist/img/AdminLTELogo.png"
				alt="AdminLTE Logo" class="brand-image img-circle elevation-10"
				style="opacity: .8"> <span
				class="brand-text font-weight-light">Warehouse</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img
							src="${pageContext.request.contextPath }/assets/uploads/${sessionScope.account.photo}"
							class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
						<a>Hello ${pageContext.request.userPrincipal.name }</a> &nbsp; <a
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/account/updateInfo"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">Update Info</p>
								</a></li>
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/account/changePassword"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">Change Password</p>
								</a></li>
							</ul></li>
						<st:authorize access="hasRole('ROLE_ADMIN')">
							<li class="nav-item"><a
								href="${pageContext.request.contextPath }/employee/index"
								class="nav-link"> <i class="fas fa-users"></i>
									<p style="color: white; padding-left: 8px !important">Employee
										Account</p>
							</a></li>
						</st:authorize>
						<li class="nav-item"><a
							href="${pageContext.request.contextPath }/category/index"
							class="nav-link"> <i class="nav-icon fas fa-list-ul"></i>
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/product/index"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">List</p>
								</a></li>
								<li class="nav-item"><a
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/invoice/listimport"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">List import invoices</p>
								</a></li>
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/invoice/listexport"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">List export invoies</p>
								</a></li>
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/invoice/addItemImport"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">Add import invoice</p>
								</a></li>
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/invoice/addItemExport"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">Add export invoice</p>
								</a></li>
							</ul></li>
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
								...
								<p style="color: white !important">
									Cutomer <i class="right fas fa-angle-left"></i>
								</p>
						</a>
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/customer/index"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">List</p>
								</a></li>
								<li class="nav-item"><a
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/supplier/index"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">List</p>
								</a></li>
								<st:authorize access="hasRole('ROLE_ADMIN')">
								<li class="nav-item"><a
									href="${pageContext.request.contextPath }/supplier/add"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p style="color: white !important">Add</p>
								</a></li>
								</st:authorize>
	...
	<script>
		$(function() {
			$("#importTable").DataTable(
					...
					'#importTable_wrapper .col-md-6:eq(0)');
			$("#exportTable").DataTable(
					...
					'#exportTable_wrapper .col-md-6:eq(0)');
		});
	</script>
	...
	<!-- Plugins -->
	    <script
		src="${pageContext.request.contextPath }/resources/dat/image.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/owl-carousel.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/accordions.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/datepicker.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/scrollreveal.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/waypoints.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/jquery.counterup.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/imgfix.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/slick.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/lightbox.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/dat/isotope.js"></script>


	<!-- Global Init -->
	<script
		src="${pageContext.request.contextPath }/resources/dat/custom.js"></script>
